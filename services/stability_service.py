...
Generate charts, infographics, and visual content for Brisbane property analysis
"""
...
class StabilityService:
    ...
    def _create_chart_prompt(self, data: Dict, chart_type: str) -> str:
        ...
        return f"""Create a {chart_description} showing Brisbane property market data. 
    ...
    def _create_infographic_prompt(self, suburb_data: Dict) -> str:
        ...
        suburb_name = suburb_data.get('name', 'Brisbane Suburb')
        
        return f"""Create a professional property infographic for {suburb_name}, Brisbane. 
        Modern design with Brisbane city colors (blue, green, gold). Include sections for: 
    ...
    def _create_trend_prompt(self, trend_data: List[Dict]) -> str:
        ...
        return f"""Create a professional trend analysis visualization for Brisbane property market. 
